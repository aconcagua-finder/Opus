...
- JSON схема: http://localhost:3000/api/openapi
- Описаны ручки словаря и списков слов, включая типы ответов и коды ошибок.
- **Поддержка**: не забывай обновлять `lib/openapi.ts` и страницу `/docs/api` при изменениях API.
...
**Стилизация**:
- Светлая и тёмная темы с быстрым переключением
- Cyan акценты
- Адаптивный дизайн
- Русская локализация
...
- ✅ Поддержка светлой и тёмной тем с cyan-акцентами и авто-режимом
- ✅ Русская локализация
- ✅ Адаптивный дизайн
